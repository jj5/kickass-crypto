...
abstract class KickassCrypto implements \KickassCrypto\IKickassCrypto {
  ...
  protected final function error( $function, $error, $data = null ) : bool {
    ...
    try {
      ...
      // 2023-04-07 jj5 - do_error() is supposed to return false, but we don't verify that it
      // does and it doesn't matter if it doesn't...
      //
      $this->do_error( $error );
  ...
  protected final function log_error( $message, $file, $line, $function ) : bool {
    ...
    try {
      ...
      try {
        ...
        // 2023-04-07 jj5 - keep this simple...
        //
        $this->write_log( $message, $file, $line, $function );
  ...
  /**
   * 2023-04-07 jj5 - provides our internal direct implementation of log writing, in case we need
