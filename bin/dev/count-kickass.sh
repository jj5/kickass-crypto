...
main() {
  ...
  #
  local banner=$( grep -Ri 'By jj5' bin inc src 2>/dev/null | wc -l );

  local kickass_1=$( egrep -Ri '.*kickass' bin inc src 2>/dev/null | wc -l );
  local kickass_2=$( egrep -Ri '.*kickass.*kickass' bin inc src 2>/dev/null | wc -l );
  local kickass_3=$( egrep -Ri '.*kickass.*kickass.*kickass' bin inc src 2>/dev/null | wc -l );
  local kickass_4=$( egrep -Ri '.*kickass.*kickass.*kickass.*kickass' bin inc src 2>/dev/null | wc -l );
