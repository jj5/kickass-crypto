...
```
Total Physical Source Lines of Code (SLOC)                = 8,480
...
Total Estimated Cost to Develop                           = $ 254,951
...
The string "kickass" appears in the source code 1,385 times (including the ASCII banners).
