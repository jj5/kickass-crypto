...
the potential to mature into a solid and reliable tool, but we need to go through the process.
...
succeed (such as secret keys not having been provided) the constructor should throw.
